...
- **파일 보관함** — 마크다운, PDF, CSV, 코드, 이미지, PPT, Excel을 드래그 앤 드롭으로 저장하고 내장 뷰어로 즉시 열람합니다. 미리보기를 지원하지 않는 형식은 외부 프로그램으로 엽니다.
...
- **다국어 지원** — 한국어, English, 日本語를 지원합니다. 첫 실행 시 선택하고 설정에서 언제든 변경할 수 있습니다.
